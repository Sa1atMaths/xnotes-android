    ...
    companion object {
        fun fromJson(o: JSONObject): Settings {
            ...
            return Settings(
                ...
                tools = tools,
                shapeConfig = shape,
                toolbarColors = colors.take(97),
                toolbarColorCount = o.optInt("toolbar_color_count", 5).coerceIn(1, 97),
                toolbarLayout = toolbarLayout(o.optJSONObject("toolbar_layout")),
                activeColor = o.optInt("active_color", 0).coerceIn(0, 96),
